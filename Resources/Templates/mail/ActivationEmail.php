	...
	$html[] = "<tr>";
		$html[] = "<td valign='top' style='border-width: 2px; border-color: #ECECEC; border-style: solid;  line-height: 24px; font-size: 16px; margin: 0;' align='left'>";
			$html[] = "<div style='width: 90%; background-color: #FFF; text-wrap: wrap; margin: 0 auto; padding: 20px;'>";
				$html[] = "<h1 style='font-weight: 500; vertical-align: baseline; font-size: 26px; line-height: 43.2px; margin: 0; padding: 0;' align='left'>Welcome to ".CONFIG['site_name']."</h1>";
				$html[] = "<p style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left'>Your account has been created. Please activate your account by clicking on the link below.</p>";
				$html[] = "<br/><a href='". $data['url'] ."' style='color: #0d6efd;'>Activate your account</a><br/><br/>";
