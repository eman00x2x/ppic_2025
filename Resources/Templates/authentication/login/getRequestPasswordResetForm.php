...
$html[] = "<div class='d-flex flex-column'>";
	$html[] = "<div class='page page-center'>";
		$html[] = "<div class='container container-tight py-4'>";
			...
			$html[] = "<form id='form' class='card card-md' action='".url("login.sendPasswordResetLink")."' method='POST' autocomplete='off'>";
				
				$html[] = "<div class='card-body'>";
					$html[] = "<h2 class='card-title text-center mb-4'>Request Password Reset</h2>";
					...
					$html[] = "<div class='form-footer'>";
						$html[] = "<span class='btn btn-primary w-100 btn-verify-email'><i class='ti ti-send'></i> &nbsp; Send Password Reset Link</span>";
					$html[] = "</div>";
				$html[] = "</div>";
			$html[] = "</form>";

			$html[] = "<div class='text-center text-secondary mt-3'>";
				$html[] = "Forget it, <a href='".url("login")."'>send me back</a> to the sign in screen.";
			$html[] = "</div>";
