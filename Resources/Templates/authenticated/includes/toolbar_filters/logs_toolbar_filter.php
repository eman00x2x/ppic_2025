					...
					$html[] = "<div class=''>";
						...
						$html[] = "<div class='mb-3'>";
							$html[] = "<div class='d-flex gap-2'>";
								$html[] = "<div class='w-100 form-floating'><input id='time_from' class='form-control' autocomplete='off' name='time[from]' type='date' value='' /><label for='time_from'>Date From</label></div>";
								$html[] = "<div class='w-100 form-floating'><input id='time_to' class='form-control' autocomplete='off' name='time[to]' type='date' value='' /><label for='time_to'>Date To</label></div>";
							$html[] = "</div>";
						$html[] = "</div>";
					$html[] = "</div>";
				$html[] = "</form>";
