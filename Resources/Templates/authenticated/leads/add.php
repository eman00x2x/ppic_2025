    ...
    $html[] = "<div class='container mb-5'>";
        ...
        $html[] = "<div class='card'>";
			$html[] = "<div class='card-body border-bottom'>";
				...
				$html[] = "<form id='form' action='".url("leads.save.new")."' method='post'>";
						...
						$html[] = "<div class='flex-grow-1'>";
							...
							$html[] = "<div class='row'>";
								$html[] = "<div class='col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12'>";
									$html[] = "<div class='form-floating mb-3'>";
										$html[] = "<input type='text' name='contact_number' id='contact_number' value='' class='form-control' />";
							...
							$html[] = "<div class='form-floating mb-3'>";
								$html[] = "<textarea name='description' id='description' class='form-control' style='height:100px;'></textarea>";
								$html[] = "<label for='title'>Description</label>";
							$html[] = "</div>";

							$html[] = "<div class='form-floating mb-3'>";
								$html[] = "<textarea name='message' id='message' class='form-control' style='height:100px;'></textarea>";
