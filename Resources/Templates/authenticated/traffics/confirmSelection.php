					...
					$html[] = "<table class='table card-table table-vcenter text-nowrap datatable'>";
						$html[] = "<thead>";
							$html[] = "<tr>";
								...
								$html[] = "<th class='align-middle'>Geo Location</th>";
								$html[] = "<th class='align-middle'>Browser</th>";
								$html[] = "<th class='align-middle'>Generated</th>";
							$html[] = "</tr>";
						$html[] = "</thead>";
						$html[] = "<tbody class='data-container'>";
							if($data['traffics']) {
								...
								for($i=0; $i<count($data['traffics']); $i++) {
									...
									$html[] = "<tr class='row_".$data['traffics'][$i]['traffic_id']."'>";
										$html[] = "<td class='text-center'>".$item_number."</td>";
										$html[] = "<td>";
											$html[] = "<span>".$data['traffics'][$i]['name']."</span>";
											$html[] = "<span class='d-block fs-12'><a href='".url("traffics.view", ["id" => $data['traffics'][$i]['traffic_id']])."' class='text-muted'>".$data['traffics'][$i]['url_cutted']." <i class='ti ti-link'></i></a></span>";
										$html[] = "</td>";
										$html[] = "<td>";
											$html[] = "<span>".$data['traffics'][$i]['ip']."</span>";
											$html[] = "<span class='d-block fs-12 text-muted'>".$data['traffics'][$i]['geo']."</span>";
										$html[] = "</td>";
										$html[] = "<td>".$data['traffics'][$i]['browser']."</td>";
										$html[] = "<td><i class='ti ti-calendar'></i> ".$data['traffics'][$i]['created_date']."</td>";
									$html[] = "</tr>";
