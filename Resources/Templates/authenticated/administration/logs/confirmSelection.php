					...
					$html[] = "<table class='table card-table table-vcenter text-nowrap datatable'>";
						$html[] = "<thead>";
							$html[] = "<tr>";
								...
								$html[] = "<th class='align-middle'>Level</th>";
								$html[] = "<th class='align-middle'>Logs</th>";
								$html[] = "<th class='align-middle'>Date</th>";
							$html[] = "</tr>";
						$html[] = "</thead>";
						$html[] = "<tbody class='data-container'>";
							if($data['logs']) {

								$item_number = View::$pagina['itemStartingNumber'] ?? 0;

								for($i=0; $i<count($data['logs']); $i++) {
									
									$html[] = "<tr>";
										$html[] = "<td class='text-center'>".$item_number."</td>";
										$html[] = "<td>".$data['logs'][$i]['level']['name']."</td>";
										$html[] = "<td>".$data['logs'][$i]['main_message']."</td>";
										$html[] = "<td>".$data['logs'][$i]['date']."</td>";
									$html[] = "</tr>";
