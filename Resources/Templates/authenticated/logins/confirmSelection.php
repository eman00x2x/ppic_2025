	...
	$html[] = "<div class='row justify-content-center'>";
		$html[] = "<div class='col-lg-8 col-md-8 col-sm-12 col-12'>";
			...
			$html[] = "<div class='d-flex mb-3'>";
				$html[] = "<div class=''>";
					$html[] = "<h1 class='text-danger'><i class='ti ti-info-square-rounded fs-36 me-1'></i> Confirm Deletion</h1>";
					...
					$html[] = "<table class='table card-table table-vcenter text-nowrap datatable'>";
						$html[] = "<thead>";
							$html[] = "<tr>";
								...
								$html[] = "<th class='align-middle'>Logins</th>";
							$html[] = "</tr>";
						$html[] = "</thead>";
						$html[] = "<tbody class='data-container'>";
							if($data['logins']) {

								$itemNumber = View::$collections['itemStartingNumber'] ?? 0;

								for($i=0; $i<count($data['logins']); $i++) {
									
									$html[] = "<tr>";
										$html[] = "<td class='text-center'>".$itemNumber."</td>";
										$html[] = "<td>".$data['logins'][$i]['login_browser']." > ".$data['logins'][$i]['login_location']."</td>";
									$html[] = "</tr>";
