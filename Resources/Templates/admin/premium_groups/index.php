    ...
    $html[] = "<div class='container-xl'>";
        $html[] = "<div class='row g-2 align-items-center'>";
            ...
            $html[] = "<div class='col'>";
                ...
                $html[] = "<h2 class='page-title'>Premium Groups</h2>";
            $html[] = "</div>";

            $html[] = "<div class='col-auto ms-auto d-print-none'>";
                $html[] = "<div class='btn-list'>";
                    $html[] = "<a href='".url("PremiumGroupsController@add")."' class='btn btn-primary'><i class='ti ti-plus me-1'></i> New Premium Group</a>";
                $html[] = "</div>";
            $html[] = "</div>";
            ...
            $html[] = "<div class='flex-grow-1 '>";
                $html[] = "<div class='bg-white border d-flex gap-2 align-items-center mb-1'>";
                    ...
                    $html[] = "<div class='input-icon w-100 ms-2'>";
                        ...
                        $html[] = "<input type='text' id='search' class='form-control border-0 p-3 ms-4' placeholder='Search' data-url='".url("PremiumGroupsController@index")."' />";
                    $html[] = "</div>";
            ...
            $html[] = "<div class='ms-1 cursor-pointer mb-1'>";
                ...
                $html[] = "<div class='dropdown-menu'>";
                    ...
                    foreach(["name", "created_at"] as $field) {
                        ...
                        $html[] = "<a class='dropdown-item d-flex justify-content-between' href='".url("PremiumGroupsController@index", null, $request)."'><span>".$name."</span> <span class='text-muted fs-11'>$direction</span></a>";
                    }
                $html[] = "</div>";
            $html[] = "</div>";
            ...
            $html[] = "<div class='ms-1 cursor-pointer mb-1'>";
                ...
                $html[] = "<div class='dropdown-menu'>";
                    ...
                    foreach([20, 50, 80, 100, 200, 500, 1000] as $rows) {                        
                        $limit["rows"] = $rows;
                        $html[] = "<a class='dropdown-item d-flex justify-content-between' href='".url('PremiumGroupsController@index', null, $limit)."'><span>Show $rows rows</span></a>";
                    }
                $html[] = "</div>";
            $html[] = "</div>";

            $html[] = "<a href='".url("PremiumGroupsController@index")."' class='btn rounded-0 ms-1 mb-1'>Clear filter</a>";
                    ...
                    $html[] = "<tbody class='data-container'>";
                        if($data) {
                            for($i=0; $i<count($data); $i++) {
                                ...
                                $html[] = "<tr class='row_".$data[$i]['premium_group_id']."'>";
                                    $html[] = "<td class='text-center'>".$model->page['starting_number']."</td>";
                                    $html[] = "<td>".$data[$i]['name']."</td>";
                                    $html[] = "<td>".$data[$i]['description']."</td>";
                                    $html[] = "<td>".$data[$i]['created_at']."</td>";
                                    $html[] = "<td class='d-flex gap-2'>";
                                        $html[] = "<span><a href='".url("premiumgroups.edit", ["id" => $data[$i]['premium_group_id']])."' class='btn btn-sm btn-primary'><i class='ti ti-edit fs-14 me-1'></i>Edit</a></span>";
                                        $html[] = "<span><span class='btn btn-sm btn-danger btn-show-offconvas' data-url='".url("premiumgroups.delete", ["id" => $data[$i]['premium_group_id']])."' data-bs-toggle='offcanvas' data-bs-target='#offcanvasEnd' role='button' aria-controls='offcanvasEnd'><i class='ti ti-trash fs-14 me-1'></i>Delete</span></span>";
                                    $html[] = "</td>";
                                $html[] = "</tr>";
