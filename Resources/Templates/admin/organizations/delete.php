...
$html[] = "<div class='offcanvas-header'>";
  $html[] = "<h5 class='offcanvas-title'>Delete Organization</h5>";
...
$html[] = "<div class='offcanvas-body'>";
    ...
    $html[] = "<p class='mt-3'>All data related to this Organization will be permanently deleted and this action is ireversible, Are you sure do you want to continue the deletion of this organization?</p>";
    ...
    $html[] = "<div class='btn-delete-controls'>";
		$html[] = "<div class='btn-list'>";
			...
			$html[] = "<span data-url='".url("organizations.delete",["id" => $data['organization_id']], ["delete" => "true"])."' data-row='row_".$data['organization_id']."' class='btn btn-danger btn-continue-delete'><i class='ti ti-trash me-2'></i> Continue Deletion</span>";
		$html[] = "</div>";
	$html[] = "</div>";
