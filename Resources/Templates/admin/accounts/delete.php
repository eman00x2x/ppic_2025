...
$html[] = "<div class='offcanvas-body'>";
    ...
    $html[] = "<div class='mb-3'>";
        $html[] = "<span class='avatar avatar-xxl' style='background-image:url(".$data['profile_image'].")'></span>";
    $html[] = "</div>";

    $html[] = "<div class='form-floating '>";
        $html[] = "<input type='text' name='name' id='name' value='".$data['name']['firstname']." ".$data['name']['middlename']." ".$data['name']['lastname']." ".$data['name']['suffix']."' class='form-control-plaintext' readonly />";
        $html[] = "<label for='account_type'>Account Name</label>";
    $html[] = "</div>";
