...
$html[] = "<div class='offcanvas-header'>";
  $html[] = "<h5 class='offcanvas-title'>Delete Ebook Group</h5>";
...
$html[] = "<div class='offcanvas-body'>";
    ...
    $html[] = "<p class='mt-3'>All data related to this Ebook Group will be permanently deleted and this action is ireversible, Are you sure do you want to continue the deletion of this ebook group?</p>";
    ...
    $html[] = "<div class='btn-delete-controls'>";
		$html[] = "<div class='btn-list'>";
			...
			$html[] = "<span data-url='".url("ebookgroups.delete",["id" => $data['ebook_group_id']], ["delete" => "true"])."' data-row='row_".$data['ebook_group_id']."' class='btn btn-danger btn-continue-delete'><i class='ti ti-trash me-2'></i> Continue Deletion</span>";
		$html[] = "</div>";
	$html[] = "</div>";
