...
class PayPal {
    ...
    private	$clientSecret = PAYPAL_CLIENT_SECRET;
    ...
    function createOrder($data, $validation_url, $payment_status_url) {
        ...
        $this->doc->addScript("https://www.paypal.com/sdk/js?client-id=".$this->clientId."&currency=".$this->currency."&intent=capture&commit=false&vault=false&disable-funding=card");
	...
	function generateAccessToken() {
		...
		curl_setopt($handle, CURLOPT_POST, true);
		curl_setopt($handle, CURLOPT_SSL_VERIFYPEER, false);
		curl_setopt($handle, CURLOPT_USERPWD, $this->client_id.":".$this->clientSecret);
