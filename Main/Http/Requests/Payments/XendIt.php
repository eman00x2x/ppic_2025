...
class XendIt {
    ...
    function requestInvoice($data, $payment_status_url) {
		...
		$this->uniqueId = $data['premium_id']."".$this->session['account_id'];

		$post_data = json_encode([
			"external_id" => "testing_external_id-".$this->uniqueId,
	...
	function request($method, $end_point, $data = null, $headers = array()) {

		$handle = curl_init($end_point);
